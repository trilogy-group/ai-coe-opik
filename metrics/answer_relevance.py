...
class CustomAnswerRelevance(CustomGEval):
    ...
    def __init__(self, name: str = "answer_relevance", model: Optional[str] = None):
        ...
        """
        task_intro = "You are an expert in evaluating the relevance of answers to questions."
...
def create_answer_relevance_metric(model: Optional[str] = None) -> CustomAnswerRelevance:
    """
